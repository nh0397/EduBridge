  ...
  return (
    <Box className="file-details-container">
      ...
      <Box className="sidebar">
        {metadata && (
          <>
            <FontAwesomeIcon icon={getFileIcon(metadata.filename_disk)} size="2x" className="file-icon-details" />
            <Typography variant="h5" className="file-details-title">{metadata.title || 'Detail not available'}</Typography>
            <Typography variant="body2" className="description-preview-details">{metadata.description}</Typography>
