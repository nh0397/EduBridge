...
const DIRECTUS_API_URL = 'http://localhost:8055'; // Your Directus instance URL
const DIRECTUS_API_TOKEN = 'uSsMIFMN9coYvHt9XGtFHh9fKNLUDHgj'; // Static token for API access
